...
public class NameServerRegister implements Serializable
{
	...
	public void addNode(String hostName, String hostIP)
	{
		...
		} else
		{
			...
			SystemyLogger.log(Level.INFO, logName + hostName + " (hashcode: " + nodeHash + ")" + hostIP + " is added to the register");
		}
	}
	...
	public String getFileLocation(int fileHash)
	{
		...
		} else
		{
			...
			SystemyLogger.log(Level.INFO, logName + temp.get(temp.lastKey()) + " (" + temp.lastKey() + " ): is the owner of this file");
	...
	public int getNextNode(int nodeHash)
	{
		...
		} else
		{
			...
			SystemyLogger.log(Level.INFO, logName + "This is the nextNode " + Collections.min(tempArray));
			return Collections.min(tempArray);
		}
	...
	public int getPreviousNode(int nodeHash)
	{
		...
		} else
		{
			...
			SystemyLogger.log(Level.INFO, logName + "This is the previoustNode " + Collections.max(tempArray));
