...
public class NameServerRegister implements Serializable
{
	...
	public int getNextNode(int nodeHash)
	{
		...
		} else
		{
			...
			SystemyLogger.log(Level.INFO, logName + "This is the previousNode " + Collections.min(tempArray));
	...
	public int getPreviousNode(int nodeHash)
	{
		...
		} else
		{
			...
			SystemyLogger.log(Level.INFO, logName + "This is the nextNode " + Collections.max(tempArray));
