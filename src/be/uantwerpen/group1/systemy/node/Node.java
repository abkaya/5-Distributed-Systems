...
public class Node implements NodeInterface
{
	...
	// Check whether it's a server or a node
	...
	/**
	 * At startup the Node is going to load his files in the list. 
	 */
	private static void LoadFiles()
	{
		...
		{
			me.addFileToFileList(listOfFiles[i].getName(), false);
		}
	}
	...
	public static void previousFailed()
	{
		try
		{
			...
			callFailureAgent(newPreviousIP);
	...
	public static void callFailureAgent(String failedHostIp)
	{

	}

	public static void startFileAgent()
	{

	}

	/**
	 * Methods for asking the user which file he wishes to download
	 * For testing the lock on a file
	 * @return Strin: the filename
	 */
	public static void downloadFile()
	{

		Scanner user_input = new Scanner(System.in);
		System.out.println("Geef de filename (+ extensie) in die u wenst te downloaden: ");
		String fileToLock = user_input.next();
		
		System.out.println(fileToLock);
		me.lockFile(fileToLock, true);
